...
import com.sitech.family.custservice.mapper.IMbrPrcMidMapper;
...
public class MbrPrcMidImpl implements IMbrPrcMid {
    ...
    public ReturnDto create(MbrPrcMid mbrPrcMid) {
        ...
        try {
            ...
            throw new BusiException(getErrorCode("1000", "15000"), "创建成员订购实例失败" + e.getMessage());
        }
    ...
    public ReturnDto modify(MbrPrcMid mbrPrcMid) {
        ...
        try {
            ...
            throw new BusiException(getErrorCode("1000", "15000"), "更新成员订购实例失败" + e.getMessage());
        }
    ...
    public ReturnDto drop(MbrPrcMid mbrPrcMid) {
        ...
        try {
            ...
            throw new BusiException(getErrorCode("1000", "15000"), "删除成员订购实例失败" + e.getMessage());
        }
    ...
    public MbrPrcMid query(String insType, BigDecimal insValue) {
        ...
        try {
            ...
            throw new BusiException(getErrorCode("1000", "15000"), "查询成员订购实例失败" + e.getMessage());
        }
    ...
    public List<MbrPrcMid> qryMbrPrcMidHisList(Map map) {
        ...
        try {
            ...
            throw new BusiException(getErrorCode("1000", "15000"), "查询历史表成员订购实例失败" + e.getMessage());
        }
