...
public class User implements Serializable {
    ...
    private String brandCreateType;
    ...
    public Long getCmdRight() {
        return cmdRight;
    }

    public void setCmdRight(Long cmdRight) {
    ...
    public String getOwnedChnlId() {
        return ownedChnlId;
    }

    public void setOwnedChnlId(String ownedChnlId) {
        this.ownedChnlId = ownedChnlId;
    }
    ...
    public String getBrandCreateType() {
        return brandCreateType;
    }

    public void setBrandCreateType(String brandCreateType) {
        this.brandCreateType = brandCreateType;
    }

    public UserGoods getGoods() {
        return goods;
    }
    ...
    public String toString() {
        return "User{" +
                ...
                ", empId='" + empId + '\'' +
                ", empGroup='" + empGroup + '\'' +
                ", brandCreateType='" + brandCreateType + '\'' +
                ", goods=" + goods +
                '}';
    }
}
